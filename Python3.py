...
This_list2 = ["apple", "bannana","coconut","apple","banana"]
This_list3 = ["mango", "pineapple", "grape"]
This_list2.extend(This_list3)
print(This_list2, len(This_list2))

This_list4 = ["apple", "bannana","coconut","apple","banana"]
This_list4.remove("banana")
print(This_list4, len(This_list4))

This_list5 = ["apple", "bannana","coconut","apple","banana"]
This_list5.pop(2)
print(This_list5, len(This_list5))

This_list6 = ["apple", "bannana","coconut","apple","banana"]
del This_list6[1]
...
print(this_set8, type(this_set8))
del this_set8
# print(this_set8, type(this_set9))
